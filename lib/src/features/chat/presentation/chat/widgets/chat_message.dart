...
import 'package:hnk_ask_ai/src/features/chat/domain/model/message_model.dart';
...
class _ChatMessageState extends State<ChatMessage> {
  ...
  void initState() {
    ...
    messages = [
      ...
      MessageModel(
          sender: MessageSender.user, content: 'Sounds good! How do I begin?'),
      MessageModel(
          sender: MessageSender.askAi,
          content:
      ...
      MessageModel(
          sender: MessageSender.user, content: 'Interesting! I\'ll try that.'),
      MessageModel(
          sender: MessageSender.askAi,
          content:
              'Good luck! If you have any more questions, feel free to ask.'),
      MessageModel(sender: MessageSender.user, content: 'Thank you so much!'),
    ];
